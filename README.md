# Nocho — Frontend B (Mock / Design Sandbox)

> **Branch:** `frontend-b-mock`
> **Purpose:** Design sandbox — no database or external services needed
> **Backend:** In-memory (resets on server restart)

Use this branch to build and test **Design B** frontend changes. All data is mocked in memory so you can focus purely on UI without any backend setup.
...
This is a **design-only sandbox**. Make UI changes, test layouts, and iterate on Design B here freely. When a design is approved, port the changes to:
